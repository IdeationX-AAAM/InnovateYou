...
const SignUp =()=>{
    return(
        <>
             <div className="max-w-md relative flex flex-col p-4 rounded-md text-black bg-white mx-auto mt-32 border border-gray-300 ">
      <div className="text-2xl font-bold mb-2 text-[#1e0e4b] text-center">Hi There , Welcome To <span className="text-[#7747ff]">App</span></div>
      <div className="text-sm font-normal mb-4 text-center text-[#1e0e4b]">Create An Account</div>
      <form className="flex flex-col gap-3">
        ...
        <div className="block relative"> 
          ...
          <input type="password" id="confirm-password" className="rounded border border-gray-200 text-sm w-full font-normal leading-[18px] text-black tracking-[0px] appearance-none block h-11 m-0 p-[11px] focus:ring-2 ring-offset-2 ring-gray-900 outline-0" />
        </div>
